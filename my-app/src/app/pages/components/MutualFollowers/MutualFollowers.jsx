import './MutualFollowers.styles.css';

export function MutualFollowers()
{
    return(
    <>
      <div className="main-follow__user-info">
        <div className="main-follow__user-header">
        ...
        <div className="main-follow__user">
          <span className="main-follow__user-name">Mikael Stanley</span>
          <span className="main-follow__user-followers">
            230 k Followers
          </span>
        </div>
        <div className="main-follow__actions">
